	 ...
	 <li><a href="adauga_Consultatie.jsp">Consultatie</a></li>
        ...
        <form action="ConsultatieController" method="POST">
            <p align="center">
                ...
                <button id='sub' type="submit" id="modificaConsultatie" name="modificaConsultatie"> Modifica</button> <br> <br>
                <button id='sub2'type="submit" id="stergeConsultatie" name="stergeConsultatie"> Sterge </button>
            </p>
        </form>
        <br>
